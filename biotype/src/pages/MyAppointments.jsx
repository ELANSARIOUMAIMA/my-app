      ...
      <div className="">
        {
          coaches.slice(0,2).map((item,index)=>(
            <div  key={index} className="grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b ">
              <div className=""><img src={item.image} alt="" className=" w-40 h-40  object-cover rounded-xl" /></div>
              ...
              <div className="flex flex-col gap-2 justify-end">
                ...
                <button className="text-sm text-stone-500 text-center sm:min-w-48 py-2 border rounded hover:bg-end hover:text-white transition-all duration-300">Cancel appointment</button>
              </div>
