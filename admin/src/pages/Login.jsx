  ...
  return (
    <form onSubmit={onSubmitHandler} action="" className="min-h-[80vh] flex items-center">
       <div className="flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-[#5E5E5E] text-sm shadow-lg ">
        ...
        <button className="bg-primary text-white w-full py-2  rounded-mt text-base">Login</button>
        {
            state==='Admin'
            ? <p className="">Coach Login? <span onClick={()=>setState('Coach')} className="text-primary underline cursor-pointer"> Click Here</span></p>
